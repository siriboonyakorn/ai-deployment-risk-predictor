        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              disabled={!isLoaded}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl text-sm font-semibold transition-all cursor-pointer disabled:opacity-50"
              style={{
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                el.style.background = "rgba(234,67,53,0.08)";
                el.style.boxShadow = "0 0 20px rgba(234,67,53,0.2)";
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget;
                el.style.borderColor = "var(--border)";
            ...
            >
              ...
              <svg width="20" height="20" viewBox="0 0 48 48" fill="none">
                ...
                <path d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.308 0-9.614-3.417-11.284-8.124l-6.522 5.025C9.505 39.556 16.227 44 24 44z" fill="#4CAF50"/>
